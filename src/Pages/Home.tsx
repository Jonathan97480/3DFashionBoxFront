...
export default function Home() {
  ...
  const [screen, setScreen] = React.useState<screenInterface>({
    screen: "home",
  });
  ...
  return (
    <div className="homeScreen">
      <div className="homeScreen_select">
        <button onClick={() => setScreen({ screen: "libGames" })}>
          <img
            src={libGamesPicture}
            alt="lib Game picture"
            width={160}
            height={200}
          />
        </button>
        <button onClick={() => setScreen({ screen: "fashionBoxGames" })}>
          <img
            src={arcadeGamePicture}
            alt="arcade Game picture"
            width={160}
            height={200}
          />
        </button>
